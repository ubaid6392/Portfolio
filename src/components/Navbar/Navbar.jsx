...
const Navbar = () => {
  ...
  return (
    <nav className={`fixed top-0 w-full z-50 transition duration-300 px-[7vw] md:px-[7vw] lg:px-[20vw] ${
        isScrolled ? "bg-[#050414] bg-opacity-40 backdrop-blur-md shadow-md" : "bg-transparent"
      }`} >
    ...
    <ul className=' hidden md:flex space-x-8 text-gray-300' >
     ...
     {/* Social Icons */}
        <div className="hidden md:flex space-x-4">
          <a
            href="https://github.com/ubaid6392"
            target="_blank"
          ...
          <a
            href="https://www.linkedin.com/in/ubaid-ullah-khan-1007b9251/"
            target="_blank"
            rel="noopener noreferrer"
            className="text-gray-300 hover:text-[#8245ec]"
          >
